...
par(mfrow = c(2, 2))
x <- rt(1e4, 7)
hist(x, freq = FALSE, ylim = c(0, 0.4), main = "Leptocurtica")
curve(dnorm(x), add = TRUE, lwd = 2, col = "firebrick")
qqnorm(x)
qqline(x, lwd = 2, col = "firebrick")


x <- rbeta(1e4, 3, 3)
x_scaled <- (x - mean(x)) / sd(x)
hist(x_scaled, freq = FALSE, breaks = 40, xlim = c(-3, 3), ylim = c(0, 0.5), xlab = "", 
     main = "Platicurtica")
curve(dnorm(x), add = TRUE, lwd = 2, col = "firebrick")
qqnorm(x_scaled)
qqline(x_scaled, lwd = 2, col = "firebrick")
```
