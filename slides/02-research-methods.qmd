...
- Ricerca sperimentale ([{{< fa file-pdf >}}](`r files$jhangiani2019_experimental.pdf`))
- Ricerca non-sperimentale ([{{< fa file-pdf >}}](`r files$jhangiani2019_non_experimental.pdf`))
- Ricerca quasi-sperimentale ([{{< fa file-pdf >}}](`r files$jhangiani2019_quasi_experimental.pdf`))
...
Andate a questo [link](https://docs.google.com/spreadsheets/d/16JRt1_tXYQntv2bcbvbqoOzPEZvcXPKFYpvolR16c5E/template/preview) e provate ad esplorare il dataset. Cosa notate?
...
## Variabili estranee, confounder e covariate
