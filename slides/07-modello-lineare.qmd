...
- `residencesouth`: differenza in attachment tra nord e sud [quando period è zero]. Quindi è la differenza tra i due gruppi fissando il valore di period a zero.
